...
public class WorldGenerator {
    ...
    public void generateTerrain(int chunkX, int chunkZ, int[] blockData, int[] heightMap) {
        terrainGenerator.generateTerrain(chunkX, chunkZ, blockData, heightMap);
    }
    ...
    public TerrainShaper getTerrainShaper() { return terrainShaper; }
    public NoiseRouter getNoiseRouter() { return noiseRouter; }
}
