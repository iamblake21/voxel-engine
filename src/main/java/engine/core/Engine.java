...
public void update(float deltaTime) {
        ...
        if (game != null) {
            // Qui dentro viene chiamato player.update(input), che APPLICA la fisica al player.
            game.update(deltaTime);
        }
        entities.update(deltaTime);
        if (world != null) {
            for (Entity e : entities.getEntities()) {
                if (e instanceof engine.entity.Player) continue; 
    ...
    public void render() {
        ...
        if (entities.getPlayer() != null) {
            ...
            for (Entity e : entities.getEntities()) {
                ...
                if (e == entities.getPlayer()) continue;
    ...
    public boolean isRunning() { return running && !window.shouldClose(); }
}