...
public class Math3D {
    ...
    public static class Vec3 {
        ...
        public Vec3 sub(Vec3 other) { return new Vec3(x - other.x, y - other.y, z - other.z); }
    ...
    public static class AABB {
        ...
        public float getCenterX() { return minX + (getWidth() / 2f); }
        public float getCenterY() { return minY + (getHeight() / 2f); }
        public float getCenterZ() { return minZ + (getDepth() / 2f); }
