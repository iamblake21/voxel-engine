...
public final class GameGuis {
        ...
        public static void register() {
                ...
                INVENTORY = Guis.builder("game:inventory", "textures/gui/inventory.png", 196, 166)
                                ...
                                .slot("main_10", 8 + 1 * SLOT_PX, 35, "main", 10)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 10)
                                .slot("main_11", 8 + 2 * SLOT_PX, 35, "main", 11)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 11)
                                .slot("main_12", 8 + 3 * SLOT_PX, 35, "main", 12)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 12)
                                .slot("main_13", 8 + 4 * SLOT_PX, 35, "main", 13)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 13)
                                .slot("main_14", 8 + 5 * SLOT_PX, 35, "main", 14)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 14)
                                .slot("main_15", 8 + 6 * SLOT_PX, 35, "main", 15)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 15)
                                .slot("main_16", 8 + 7 * SLOT_PX, 35, "main", 16)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 16)
                                .slot("main_17", 8 + 8 * SLOT_PX, 35, "main", 17)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 17)

                                // Main Inventory - Riga 3 (Assoluto 27-35)
                                .slot("main_18", 8 + 0 * SLOT_PX, 53, "main", 18)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 18)
                                .slot("main_19", 8 + 1 * SLOT_PX, 53, "main", 19)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 19)
                                .slot("main_20", 8 + 2 * SLOT_PX, 53, "main", 20)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 20)
                                .slot("main_21", 8 + 3 * SLOT_PX, 53, "main", 21)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 21)
                                .slot("main_22", 8 + 4 * SLOT_PX, 53, "main", 22)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 22)
                                .slot("main_23", 8 + 5 * SLOT_PX, 53, "main", 23)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 23)
                                .slot("main_24", 8 + 6 * SLOT_PX, 53, "main", 24)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 24)
                                .slot("main_25", 8 + 7 * SLOT_PX, 53, "main", 25)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 25)
                                .slot("main_26", 8 + 8 * SLOT_PX, 53, "main", 26)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 26)

                                // Main Inventory - Riga 4 (Assoluto 36-44)
                                .slot("main_27", 8 + 0 * SLOT_PX, 71, "main", 27)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 27)
                                .slot("main_28", 8 + 1 * SLOT_PX, 71, "main", 28)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 28)
                                .slot("main_29", 8 + 2 * SLOT_PX, 71, "main", 29)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 29)
                                .slot("main_30", 8 + 3 * SLOT_PX, 71, "main", 30)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 30)
                                .slot("main_31", 8 + 4 * SLOT_PX, 71, "main", 31)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 31)
                                .slot("main_32", 8 + 5 * SLOT_PX, 71, "main", 32)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 32)
                                .slot("main_33", 8 + 6 * SLOT_PX, 71, "main", 33)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 33)
                                .slot("main_34", 8 + 7 * SLOT_PX, 71, "main", 34)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 34)
                                .slot("main_35", 8 + 8 * SLOT_PX, 71, "main", 35)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 35)

                                // Main Inventory - Riga 5 (Assoluto 45-53) <-- L'ultima riga del tuo
                                // PlayerInventory
                                .slot("main_36", 8 + 0 * SLOT_PX, 89, "main", 36)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 36)
                                .slot("main_37", 8 + 1 * SLOT_PX, 89, "main", 37)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 37)
                                .slot("main_38", 8 + 2 * SLOT_PX, 89, "main", 38)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 38)
                                .slot("main_39", 8 + 3 * SLOT_PX, 89, "main", 39)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 39)
                                .slot("main_40", 8 + 4 * SLOT_PX, 89, "main", 40)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 40)
                                .slot("main_41", 8 + 5 * SLOT_PX, 89, "main", 41)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 41)
                                .slot("main_42", 8 + 6 * SLOT_PX, 89, "main", 42)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 42)
                                .slot("main_43", 8 + 7 * SLOT_PX, 89, "main", 43)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 43)
                ...
                CRAFTING_TABLE = Guis.builder("game:crafting_table", "textures/gui/crafting_table.png", 176, 226)
                                ...
                                // 3x3 crafting grid
                                .slot("craft_0", 30, 17, "craft_input", 0)
                                .slot("craft_1", 48, 17, "craft_input", 1)
                                .slot("craft_2", 66, 17, "craft_input", 2)
                                .slot("craft_3", 30, 35, "craft_input", 3)
                                .slot("craft_4", 48, 35, "craft_input", 4)
                                .slot("craft_5", 66, 35, "craft_input", 5)
                                .slot("craft_6", 30, 53, "craft_input", 6)
                                .slot("craft_7", 48, 53, "craft_input", 7)
                                .slot("craft_8", 66, 53, "craft_input", 8)
                                // Output slot (larger)
                                .slot("craft_output", 124, 35, "craft_output", 0)
                ...
                CHEST = createContainerSlots(
                                ...
                                Guis.builder("game:chest", "textures/gui/chest.png", 176, 240) // Aumenta l'altezza
                                                                                               // della GUI
                                                .backgroundColor(0.15f, 0.15f, 0.15f, 0.95f)
                                ...
                                .slot("main_10", 8 + 1 * SLOT_PX, 126, "main", 10)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 10)
                                .slot("main_11", 8 + 2 * SLOT_PX, 126, "main", 11)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 11)
                                .slot("main_12", 8 + 3 * SLOT_PX, 126, "main", 12)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 12)
                                .slot("main_13", 8 + 4 * SLOT_PX, 126, "main", 13)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 13)
                                .slot("main_14", 8 + 5 * SLOT_PX, 126, "main", 14)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 14)
                                .slot("main_15", 8 + 6 * SLOT_PX, 126, "main", 15)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 15)
                                .slot("main_16", 8 + 7 * SLOT_PX, 126, "main", 16)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 16)
                                .slot("main_17", 8 + 8 * SLOT_PX, 126, "main", 17)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 17)

                                // Riga 3 (Assoluto 27-35)
                                .slot("main_18", 8 + 0 * SLOT_PX, 144, "main", 18)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 18)
                                .slot("main_19", 8 + 1 * SLOT_PX, 144, "main", 19)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 19)
                                .slot("main_20", 8 + 2 * SLOT_PX, 144, "main", 20)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 20)
                                .slot("main_21", 8 + 3 * SLOT_PX, 144, "main", 21)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 21)
                                .slot("main_22", 8 + 4 * SLOT_PX, 144, "main", 22)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 22)
                                .slot("main_23", 8 + 5 * SLOT_PX, 144, "main", 23)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 23)
                                .slot("main_24", 8 + 6 * SLOT_PX, 144, "main", 24)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 24)
                                .slot("main_25", 8 + 7 * SLOT_PX, 144, "main", 25)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 25)
                                .slot("main_26", 8 + 8 * SLOT_PX, 144, "main", 26)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 26)

                                // Riga 4 (Assoluto 36-44)
                                .slot("main_27", 8 + 0 * SLOT_PX, 162, "main", 27)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 27)
                                .slot("main_28", 8 + 1 * SLOT_PX, 162, "main", 28)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 28)
                                .slot("main_29", 8 + 2 * SLOT_PX, 162, "main", 29)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 29)
                                .slot("main_30", 8 + 3 * SLOT_PX, 162, "main", 30)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 30)
                                .slot("main_31", 8 + 4 * SLOT_PX, 162, "main", 31)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 31)
                                .slot("main_32", 8 + 5 * SLOT_PX, 162, "main", 32)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 32)
                                .slot("main_33", 8 + 6 * SLOT_PX, 162, "main", 33)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 33)
                                .slot("main_34", 8 + 7 * SLOT_PX, 162, "main", 34)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 34)
                                .slot("main_35", 8 + 8 * SLOT_PX, 162, "main", 35)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 35)

                                // Riga 5 (Assoluto 45-53)
                                .slot("main_36", 8 + 0 * SLOT_PX, 180, "main", 36)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 36)
                                .slot("main_37", 8 + 1 * SLOT_PX, 180, "main", 37)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 37)
                                .slot("main_38", 8 + 2 * SLOT_PX, 180, "main", 38)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 38)
                                .slot("main_39", 8 + 3 * SLOT_PX, 180, "main", 39)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 39)
                                .slot("main_40", 8 + 4 * SLOT_PX, 180, "main", 40)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 40)
                                .slot("main_41", 8 + 5 * SLOT_PX, 180, "main", 41)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 41)
                                .slot("main_42", 8 + 6 * SLOT_PX, 180, "main", 42)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 42)
                                .slot("main_43", 8 + 7 * SLOT_PX, 180, "main", 43)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 43)
                                .slot("main_44", 8 + 8 * SLOT_PX, 180, "main", 44)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 44)
                                .register();
                ...
                DOUBLE_CHEST = createContainerSlots(
                                ...
                                .slot("main_10", 8 + 1 * SLOT_PX, 158, "main", 10)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 10)
                                .slot("main_11", 8 + 2 * SLOT_PX, 158, "main", 11)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 11)
                                .slot("main_12", 8 + 3 * SLOT_PX, 158, "main", 12)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 12)
                                .slot("main_13", 8 + 4 * SLOT_PX, 158, "main", 13)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 13)
                                .slot("main_14", 8 + 5 * SLOT_PX, 158, "main", 14)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 14)
                                .slot("main_15", 8 + 6 * SLOT_PX, 158, "main", 15)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 15)
                                .slot("main_16", 8 + 7 * SLOT_PX, 158, "main", 16)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 16)
                                .slot("main_17", 8 + 8 * SLOT_PX, 158, "main", 17)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 17)

                                .slot("main_18", 8 + 0 * SLOT_PX, 176, "main", 18)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 18)
                                .slot("main_19", 8 + 1 * SLOT_PX, 176, "main", 19)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 19)
                                .slot("main_20", 8 + 2 * SLOT_PX, 176, "main", 20)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 20)
                                .slot("main_21", 8 + 3 * SLOT_PX, 176, "main", 21)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 21)
                                .slot("main_22", 8 + 4 * SLOT_PX, 176, "main", 22)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 22)
                                .slot("main_23", 8 + 5 * SLOT_PX, 176, "main", 23)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 23)
                                .slot("main_24", 8 + 6 * SLOT_PX, 176, "main", 24)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 24)
                                .slot("main_25", 8 + 7 * SLOT_PX, 176, "main", 25)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 25)
                                .slot("main_26", 8 + 8 * SLOT_PX, 176, "main", 26)
                                .absoluteIndex(MAIN_ABSOLUTE_START + 26)
                                .register();
