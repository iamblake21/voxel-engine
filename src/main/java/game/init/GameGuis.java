...
public final class GameGuis {
    ...
    public static void register() {
        ...
        // Nota: Qui usiamo la catena esplicita di slot().absoluteIndex() per tutte le 5 righe,
        ...
        INVENTORY = Guis.builder("game:inventory", "textures/gui/inventory.png", 196, 166)
                ...
                // Main Inventory - Riga 5 (Assoluto 45-53) <-- L'ultima riga del tuo PlayerInventory
