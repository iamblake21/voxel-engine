...
2. [Requisiti e build](#requisiti-e-build)
3. [Struttura del progetto](#struttura-del-progetto)

   * [engine.core & engine.api](#enginecore--engineapi)
   * [engine.window](#enginewindow)
   * [engine.rendering](#enginerendering)
   * [engine.world & sub-package](#engineworld--sub-package)
   * [engine.entity & engine.physics](#engineentity--enginephysics)
   * [engine.registry](#engineregistry)
   * [game & game.init](#game--gameinit)
4. [Ciclo di vita del motore e interfaccia IGame](#ciclo-di-vita-del-motore-e-interfaccia-igame)
5. [Mondo, chunk e generazione procedurale](#mondo-chunk-e-generazione-procedurale)
6. [Rendering, LOD e nebbia](#rendering-lod-e-nebbia)
7. [Fisica, entità e giocatore](#fisica-entità-e-giocatore)
8. [Input, controlli e toggle di debug](#input-controlli-e-toggle-di-debug)
9. [Configurazione](#configurazione)
10. [Estendere il motore](#estendere-il-motore)
11. [Limitazioni e TODO](#limitazioni-e-todo)
...
1. **Bootstrap engine** (`engine.EngineBootstrap`):
...
2. **IGame.registerContent()** (opzionale, default vuoto)
...
1. `WorldGenerationExecutor` crea un `ChunkGenerationTask` per `(chunkX, chunkZ)` con una `priority`.
2. Un worker thread:
...
3. Il main thread recupera i task completi e:
...
2. Registrare contenuti di gioco:
